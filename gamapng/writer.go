...
func (e *encoder) writeGAMA(value uint32) {
	writeUint32(e.tmp[:4], value)
...
func Encode(w io.Writer, m image.Image, gAMA uint32) error {
	var e Encoder
	return e.Encode(w, m, gAMA)
}

// Encode writes the Image m to w in PNG format.
func (enc *Encoder) Encode(w io.Writer, m image.Image, gAMA uint32) error {
